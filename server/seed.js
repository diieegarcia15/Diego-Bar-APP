...
console.log('🍽️  Inicializando Base de Datos del Restaurante...\n');

// ==========================================
// LIMPIAR TABLAS (FORCE RESET)
// ==========================================
db.exec(`
...
console.log('🧹 Tablas anteriores eliminadas para actualización de esquema\n');
...
insertCategorias();
console.log('📂 Categorías creadas con iconos premium\n');
...
const insertProductos = db.transaction(() => {
  for (const [nombre, descripcion, precio, imagen_url, categoria_id] of productos) {
    insertProducto.run(nombre, descripcion, precio, imagen_url, categoria_id);
  }
});
insertProductos();
...
const prodCount = db.prepare('SELECT COUNT(*) as count FROM productos').get();

console.log('==========================================');
console.log('  🎉 Base de datos inicializada con éxito');
console.log('==========================================');
console.log(`  📋 Mesas:      ${mesaCount.count}`);
console.log(`  📂 Categorías: ${catCount.count}`);
console.log(`  🍽️  Productos:  ${prodCount.count}`);
console.log(`  💵 Moneda:     Pesos Argentinos ($)`);
